...
<<<<<<< HEAD:modules/ROOT/pages/java-android.adoc
=== 2.7.0
...
>>>>>>> 6f3196d1fc64f7774ef46db9901fca8884c17d55:modules/ROOT/pages/java.adoc
...
* The handling of replicator notifications has been enhanced to use a single executor.
Apps can specify custom executors in order to override the default behavior (see <<replicator-notifications-on-a-custom-executor>>).
